...
function page() {
    return (
        <div>
            <div className="w-[550px] rounded-[3px] text-[#DAC5A799] font-light h-[350px] bg-[#DAC5A70D] p-[48px] flex flex-col justify-center gap-[30px]">
                <div className="">
                    <h5>Do we Match?</h5>
                    <h3 className='text-[20px] text-[#DAC5A7]'>Development</h3>
                </div>
                <p>Before we start, we determine if and how I can help you. What <br />
                    are your requirements for your new website? Why do you need a <br />
                    new website? What goals do you have, and what problems can <br />
